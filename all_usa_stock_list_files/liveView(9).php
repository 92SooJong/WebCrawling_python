...
var SekindoClientDetections_URL = function (config) {
	this.COOKIE_TIMEOUT = 14*24*60*60;
	...
	this.setInfo = function()
	{
		...
		if (this.searchByMetaTagName)
		{
			...
			{
				ref._setMetaTagHelperContent(w.top, "name", ref.searchByMetaTagName[idx], idx);
			});
		}
	...
	this._setHelperParameters = function()
	{
		if (Object.keys(this.helperParameters).length > 0)
		{
			...
			var jsonFormattedHelperParameters = JSON.stringify(this.helperParameters);
			this.url += '&'+this.VIDEO_HELPER_PARAM_NAME+'='+encodeURIComponent(window.btoa(jsonFormattedHelperParameters));
		}
	};
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=101201&cbuster=1320761608&pubUrl=https://www.investing.com/equities/united-states&x=300&y=169&vp_content=plembedb9bwvgujmxhk&vp_template=6597&subId=[SUBID_ENCODED]&cbuster=1598662733',
					origQString: 's=101201&cbuster=1320761608&pubUrl=https://www.investing.com/equities/united-states&x=300&y=169&vp_content=plembedb9bwvgujmxhk&vp_template=6597&subId=[SUBID_ENCODED]',
					placementId: 101201,
					x: 300,
					y: 169,
					videoType: 'flow',
					...
					floatConfig: {
						...
						direction: 'bl', verticalOffset: 10,
						horizontalOffset: 10, isCloseBtn: 1,
						flowMode: 'below', closeBtnPos: 'left'
					},
					isAPI: false,
					debug: 0,
